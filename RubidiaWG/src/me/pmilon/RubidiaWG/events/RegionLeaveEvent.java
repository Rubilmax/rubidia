...
public class RegionLeaveEvent extends RegionEvent  implements Cancellable {
    ...
    public RegionLeaveEvent(ProtectedRegion region, Player player, MovementWay movement, Location from, Location to, PlayerEvent parent)
    {
        super(region, player, movement, from, to, parent);
        cancelled = false;
        cancellable = true;
